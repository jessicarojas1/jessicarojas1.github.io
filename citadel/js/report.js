...
(function (root) {
  ...
  function downloadHtmlReport(r) {
    ...
    const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>CITADEL Report — ${esc(r.meta.scannedAt)}</title>
...
h3{margin:0 0 .3rem}h5{margin:1.6rem 0 .5rem;border-bottom:2px solid #0ea5e9;padding-bottom:.2rem}
...
<body><div class="report-doc">${body}</div>
<hr><p class="small">Generated by CITADEL — heuristic + scanner analysis for triage &amp; education. Verify findings before acting.</p>
</body></html>`;
