...
final class Roles
{
    ...
    public const DEFAULTS = [
        ...
        'content_manager'  => [
            ...
            'quicklink.manage', 'faq.manage', 'milestone.view', 'milestone.manage', 'contact.manage',
            'job.view', 'job.create', 'job.edit', 'job.publish', 'directory.view',
        ],
        'contracts'        => ['announcement.view', 'document.view', 'document.create', 'document.edit', 'document.view.contracts', 'taskorder.view', 'taskorder.create', 'taskorder.edit', 'taskorder.publish', 'taskorder.approve', 'milestone.view', 'directory.view'],
        'finance'          => ['announcement.view', 'document.view', 'finance.view', 'taskorder.view', 'milestone.view'],
        'recruiting'       => ['announcement.view', 'job.view', 'job.create', 'job.edit', 'job.publish', 'directory.view', 'milestone.view'],
        'internal_member'  => ['announcement.view', 'document.view', 'taskorder.view', 'job.view', 'directory.view', 'milestone.view'],
        'sub_admin'        => ['announcement.view', 'document.view', 'taskorder.view', 'job.view', 'directory.view', 'company.roster.manage', 'access.request', 'milestone.view'],
        'sub_member'       => ['announcement.view', 'document.view', 'taskorder.view', 'job.view', 'directory.view', 'milestone.view'],
