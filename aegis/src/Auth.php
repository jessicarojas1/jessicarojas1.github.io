...
class Auth {
    ...
    public static function can(string $permission): bool {
        ...
        $defaults = [
            ...
            'auditor' => ['compliance.read', 'audit.read', 'audit.write', 'audit.edit', 'policy.read', 'risk.read'],
            'analyst' => ['compliance.read', 'audit.read', 'policy.read', 'risk.read', 'risk.write', 'risk.edit'],
