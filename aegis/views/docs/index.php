<?php
$breadcrumbs = $breadcrumbs ?? [['Docs', null]];
ob_start(); ?>
...
.docs-body pre { background:#111111; color:var(--neutral-border); padding:12px 16px; border-radius:8px; font-size:12px; overflow-x:auto; margin:8px 0 16px; }
.docs-body code { background:var(--bg-secondary); color:var(--primary); padding:1px 5px; border-radius:3px; font-size:12px; }
