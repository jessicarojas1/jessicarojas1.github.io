    ...
    <div style="display:flex;gap:0;align-items:stretch">
      <?php foreach ($steps as $i => $step): ?>
        ...
        <?php if ($i < count($steps) - 1): ?>
          <div style="display:flex;align-items:center;padding:0 4px;background:var(--bg-secondary);border-top:1px solid var(--border);border-bottom:1px solid var(--border)">
