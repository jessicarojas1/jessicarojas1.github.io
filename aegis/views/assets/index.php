  ...
  <div class="card kpi-card">
    <div class="card-body" style="display:flex;align-items:center;gap:16px;">
      <div style="width:48px;height:48px;border-radius:12px;background:rgba(100,116,139,.12);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
        <i class="bi bi-slash-circle-fill" style="font-size:22px;color:#64748b;"></i>
      </div>
      <div>
        <div style="font-size:28px;font-weight:700;line-height:1;color:#64748b;"><?= (int)($summary['decommissioned'] ?? 0) ?></div>
...
<div class="filter-bar card" style="margin-bottom:20px;">
  <form method="GET" class="filter-form" style="display:flex;flex-wrap:wrap;gap:10px;align-items:center;padding:16px;">
    <select name="type" id="assetTypeFilter" class="form-control form-control-sm">
    ...
    <select name="criticality" id="assetCritFilter" class="form-control form-control-sm">
    ...
    <select name="status" id="assetStatusFilter" class="form-control form-control-sm">
...
(function() {
  ...
  ['assetTypeFilter','assetCritFilter','assetStatusFilter'].forEach(function(id) {
