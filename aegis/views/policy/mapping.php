...
<div class="card" style="margin-bottom:16px;padding:14px 16px;">
  <form method="GET" action="/policy/mapping" style="display:flex;flex-wrap:wrap;gap:10px;align-items:flex-end;">
    <div>
      ...
      <select name="package" id="pkgFilter" class="form-control" style="min-width:200px;height:32px;font-size:0.85rem;">
    ...
    <div>
      ...
      <select name="policy" id="policyFilter" class="form-control" style="min-width:200px;height:32px;font-size:0.85rem;">
...
(function() {
  ...
  ['pkgFilter','policyFilter'].forEach(function(id) {
