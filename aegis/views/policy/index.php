...
<div class="card" style="margin-bottom:16px;padding:14px 16px;">
  <form method="GET" action="/policy" style="display:flex;flex-wrap:wrap;gap:10px;align-items:flex-end;">
    ...
    <div>
      ...
      <select name="review" id="reviewFilter" class="form-control" style="min-width:160px;height:32px;font-size:0.85rem;">
    ...
    <div>
      ...
      <select name="package" id="packageFilter" class="form-control" style="min-width:180px;height:32px;font-size:0.85rem;">
...
(function() {
  ...
  ['reviewFilter','packageFilter'].forEach(function(id) {
