    ...
    <div style="display:flex;flex-direction:column;gap:1rem">
      ...
      <div class="card" id="sevCard">
        ...
        <div class="card-body" style="text-align:center;padding:1.5rem 1rem">
          <div id="sevBadge" style="display:inline-block;padding:0.4rem 1.2rem;border-radius:99px;font-size:1rem;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;background:var(--info-subtle);color:var(--info);border:2px solid #0284c740;margin-bottom:0.75rem">Medium</div>
