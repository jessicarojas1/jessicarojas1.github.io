...
<button id="btnPrint" class="print-btn"><i>⎙</i> Print / Save PDF</button>
    ...
    <div class="control">
      ...
      <div class="control-body">
        ...
        <div class="field-block">
          ...
          <div class="save-row">
            <button class="save-btn" data-field="implementation_statement">Save</button>
        ...
        <div class="field-block">
          ...
          <div class="save-row">
            <button class="save-btn" data-field="objective_responses">Save</button>
            <span class="save-status"></span>
          </div>
        </div>
        ...
        <div class="field-block">
          ...
          <div class="save-row">
            <button class="save-btn" data-field="responsible_roles">Save</button>
            <span class="save-status"></span>
          </div>
        </div>
...
document.addEventListener('click', function(e) {
  ...
  if (btn) saveStatement(btn, btn.dataset.field);
});
