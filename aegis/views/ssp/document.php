...
document.getElementById('btnWord').addEventListener('click', function() {
  ...
  var css = [
    ...
    '.impact-low{background:var(--success-subtle);color:#065f46}.impact-moderate{background:#fef3c7;color:#92400e}.impact-high{background:var(--danger-subtle);color:var(--danger)}',
    ...
    '.status-compliant{background:var(--success-subtle);color:#065f46}.status-partial{background:#fef3c7;color:#92400e}',
