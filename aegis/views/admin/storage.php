...
<form method="POST" action="/admin/storage/save" style="flex:2;min-width:320px">
  ...
  <div class="card" style="margin-bottom:16px">
    ...
    <div class="card-body" style="display:flex;flex-direction:column;gap:16px">
      <div class="form-group">
        ...
        <select name="storage_driver" class="form-control" id="driverSelect">
  ...
  <div class="card">
    <div class="card-footer" style="display:flex;gap:8px;padding:16px">
      ...
      <button type="button" class="btn btn-secondary" id="testBtn"><i class="bi bi-lightning-charge"></i> Test Connection</button>
    </div>
  </div>
</form>
...
document.getElementById('driverSelect').addEventListener('change', toggleS3Fields);
document.getElementById('testBtn').addEventListener('click', testStorage);
