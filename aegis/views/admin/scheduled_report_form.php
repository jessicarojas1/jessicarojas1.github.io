...
<form method="post" action="<?= Security::h($formAction) ?>" style="max-width:720px">
  ...
  <div class="card" style="margin-bottom:20px">
    ...
    <div class="card-body">
      ...
      <div style="display:flex;align-items:center;gap:10px;padding-top:14px;border-top:1px solid var(--border,#e5e7eb)">
    ...
    <div class="card-footer" style="padding:16px 20px;border-top:1px solid var(--border,#e5e7eb);display:flex;gap:10px">
