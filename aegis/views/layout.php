...
<link rel="stylesheet" href="/public/vendor/bootstrap/bootstrap.min.css" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
  ...
  <nav class="sidebar-nav">
    ...
    <div class="nav-acc">
      ...
      <div class="nav-acc-body" id="nav-acc-compliance">
        ...
        <?php if (moduleVisible('compliance',     $__mv)): ?><a href="/compliance/crosswalk" class="nav-item"><i class="bi bi-diagram-3-fill"></i><span>Crosswalk</span></a><?php endif; ?>
