...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <?php endif; ?>
    <?php if (moduleVisible('compliance_gap', $__mv)): ?>
    ...
    <?php endif; ?>
    <?php endif; /* end compliance section */ ?>
