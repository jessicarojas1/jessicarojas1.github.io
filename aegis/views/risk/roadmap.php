...
<div class="filter-bar card" style="margin-bottom:20px;">
  <form method="GET" style="display:flex;flex-wrap:wrap;gap:10px;align-items:center;padding:14px 16px;">
    <select name="status" class="form-control form-control-sm roadmap-autosubmit">
    ...
    <select name="owner_id" class="form-control form-control-sm roadmap-autosubmit">
    ...
    <select name="level" class="form-control form-control-sm roadmap-autosubmit">
...
document.querySelectorAll('.roadmap-autosubmit').forEach(function(sel) {
