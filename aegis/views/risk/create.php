          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <div class="slider-group">
                <input type="range" name="likelihood" min="1" max="5" value="3" id="likelihood">
            ...
            <div class="form-group">
              ...
              <div class="slider-group">
                <input type="range" name="impact" min="1" max="5" value="3" id="impact">
          ...
          <div class="form-group">
            ...
            <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:6px" id="strategyGrid">
              ...
              <label style="display:flex;flex-direction:column;align-items:center;gap:5px;padding:12px 8px;border-radius:8px;border:2px solid var(--border);background:var(--bg-secondary);cursor:pointer;text-align:center;transition:all .15s" class="strat-lbl" id="slbl_<?= $k ?>">
                <input type="checkbox" name="treatment_strategies[]" value="<?= $k ?>" style="position:absolute;opacity:0" class="strat-cb-input">
        ...
        <div style="margin-top:20px">
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <div class="slider-group">
                <input type="range" name="velocity" min="1" max="5" value="3" id="velocitySlider">
...
// Wire up score sliders
document.getElementById('likelihood').addEventListener('input', function() { updateScore(); });
document.getElementById('impact').addEventListener('input', function() { updateScore(); });

// Wire up velocity slider
document.getElementById('velocitySlider').addEventListener('input', function() {
  document.getElementById('velocityVal').textContent = this.value;
});

// Wire up strategy checkboxes
document.querySelectorAll('.strat-cb-input').forEach(function(cb) {
  cb.addEventListener('change', function() {
    // Find closest label with an id starting with 'slbl_'
    var lbl = this.closest('label[id]');
    if (lbl) {
      var key = lbl.id.replace('slbl_', '');
      toggleStrat(key);
    }
  });
});
