<!DOCTYPE html>
<html lang="en" style="color-scheme:light dark"><head><meta charset="UTF-8"><title>429 — AEGIS GRC</title>
...
</head><body><div class="box"><div class="icon">🐢</div><div class="title">429 — Too Many Requests</div><div class="sub">You've made too many requests in a short period. Please wait a moment and try again.</div><a href="/">Back to Dashboard</a></div></body></html>
