<!DOCTYPE html>
<html lang="en" style="color-scheme:light dark"><head><meta charset="UTF-8"><title>401 — AEGIS GRC</title>
...
</head><body><div class="box"><div class="icon">🔑</div><div class="title">401 — Authentication Required</div><div class="sub">You must sign in to access this resource.</div><a href="/login">Sign in</a></div></body></html>
