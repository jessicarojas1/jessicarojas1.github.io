...
<div class="tab-bar" style="margin-bottom:20px">
  <button class="tab-btn active" data-click="switchTabBtn" data-arg="csv"><i class="bi bi-filetype-csv"></i> CSV</button>
  <button class="tab-btn"        data-click="switchTabBtn" data-arg="excel"><i class="bi bi-file-earmark-excel-fill"></i> Excel</button>
  <button class="tab-btn"        data-click="switchTabBtn" data-arg="pdf"><i class="bi bi-file-earmark-pdf-fill"></i> PDF</button>
  <button class="tab-btn"        data-click="switchTabBtn" data-arg="json"><i class="bi bi-filetype-json"></i> JSON</button>
  <button class="tab-btn"        data-click="switchTabBtn" data-arg="manual"><i class="bi bi-plus-circle-fill"></i> Single Control</button>
</div>
...
// Adapter: called via data-click="switchTabBtn" data-arg="tabName"
function switchTabBtn(name) {
  var btn = document.querySelector('[data-click="switchTabBtn"][data-arg="' + name + '"]');
  switchTab(name, btn || document.createElement('button'));
}
...
// Adapter: called via data-change="showFileChange" on file inputs
function showFileChange(e) {
  var input = e && e.target ? e.target : this;
  showFile(input, input.dataset.dropId, input.dataset.nameId, input.dataset.color);
}
