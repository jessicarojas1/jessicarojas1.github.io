        ...
        <form method="POST" action="/compliance/<?= $objective['package_id'] ?>/objective/<?= $objective['id'] ?>/update">
          ...
          <div class="form-group">
            ...
            <div class="status-selector">
              <?php $statuses = ['not_started'=>['circle','Not Started','#a1a1aa'],'compliant'=>['check-circle-fill','Compliant','var(--success)'],'partial'=>['dash-circle-fill','Partial','var(--warning)'],'non_compliant'=>['x-circle-fill','Non-Compliant','var(--danger)'],'not_applicable'=>['slash-circle-fill','N/A','#71717a']]; ?>
