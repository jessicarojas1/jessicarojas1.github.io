...
<div class="page-header">
  ...
  <button id="btnOpenCreate" class="btn btn-primary"><i class="bi bi-plus-lg"></i> New Dashboard</button>
</div>
...
<div class="card" style="text-align:center;padding:60px 20px;">
  ...
  <button id="btnOpenCreate2" class="btn btn-primary">Create First Dashboard</button>
</div>
<?php else: ?>
...
(function() {
  ...
  document.getElementById('btnOpenCreate').addEventListener('click', open);
  var btn2 = document.getElementById('btnOpenCreate2');
  if (btn2) btn2.addEventListener('click', open);
  document.getElementById('btnCloseCreate').addEventListener('click', close);
  document.getElementById('btnCancelCreate').addEventListener('click', close);
