...
<div class="page-header">
  ...
  <button class="btn btn-primary" onclick="document.getElementById('createModal').style.display='flex'"><i class="bi bi-plus-lg"></i> New Dashboard</button>
</div>
...
<div class="card" style="text-align:center;padding:60px 20px;">
  ...
  <button class="btn btn-primary" onclick="document.getElementById('createModal').style.display='flex'">Create First Dashboard</button>
</div>
<?php else: ?>
<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:20px;">
  ...
  <div class="card" style="display:flex;flex-direction:column;gap:0;">
    ...
    <div style="padding:12px 20px;border-top:1px solid var(--border);display:flex;gap:8px;">
      ...
      <form method="POST" action="/dashboards/<?= (int)$d['id'] ?>/delete" onsubmit="return confirm('Delete this dashboard?')" style="margin:0;">
