...
<div class="card" style="margin-bottom:1rem">
  <div class="card-body" style="padding:0.75rem 1rem">
    <form method="GET" action="/incident" style="display:flex;gap:0.75rem;align-items:center;flex-wrap:wrap">
      <select name="severity" id="incidentSeverityFilter" class="form-control" style="width:auto;min-width:140px">
      ...
      <select name="status" id="incidentStatusFilter" class="form-control" style="width:auto;min-width:150px">
...
(function() {
  var incidentSeverityFilter = document.getElementById('incidentSeverityFilter');
  if (incidentSeverityFilter) { incidentSeverityFilter.addEventListener('change', function() { this.form.submit(); }); }
  var incidentStatusFilter = document.getElementById('incidentStatusFilter');
  if (incidentStatusFilter) { incidentStatusFilter.addEventListener('change', function() { this.form.submit(); }); }
})();
</script>
<?php
