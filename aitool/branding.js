/* ============================================================
 * Branding module — AI Tool Evaluation Framework (aitool)
...
(function () {
  ...
  var STORAGE_KEY = 'aitool.branding.v1';
  var DEFAULT_NAME = 'AI Tool Evaluation Framework';
  var DEFAULT_TITLE = 'AI Tool Evaluation Framework | Aerospace | Jessica Rojas';
  ...
  function buildModal() {
    ...
    wrap.innerHTML = [
      ...
      '        <h2 class="modal-title fs-5" id="brandingModalLabel">⚙️ Settings — Branding</h2>',
