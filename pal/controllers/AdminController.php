...
/**
 * AdminController — the Administration module for the PAL Platform.
...
class AdminController {
    ...
    public function index(): void {
        ...
        require PAL_ROOT . '/views/admin/index.php';
    }
    ...
    public function users(): void {
        ...
        require PAL_ROOT . '/views/admin/users.php';
    }

    public function createUserForm(): void {
        Auth::requireAdmin();
        require PAL_ROOT . '/views/admin/user_form.php';
    }
    ...
    public function permissions(int $userId = 0): void {
        ...
        if (!$users) { require PAL_ROOT . '/views/admin/permissions.php'; return; }
        ...
        require PAL_ROOT . '/views/admin/permissions.php';
    }
    ...
    public function branding(): void {
        Auth::requireAdmin();
        require PAL_ROOT . '/views/admin/branding.php';
    }
    ...
    public function settings(): void {
        ...
        require PAL_ROOT . '/views/admin/settings.php';
    }
    ...
    public function tags(): void {
        ...
        require PAL_ROOT . '/views/admin/tags.php';
    }
    ...
    public function apiKeys(): void {
        ...
        require PAL_ROOT . '/views/admin/api_keys.php';
    }
    ...
    public function logs(): void {
        ...
        require PAL_ROOT . '/views/admin/logs.php';
    }
    ...
    public function sessions(): void {
        ...
        require PAL_ROOT . '/views/admin/sessions.php';
    }
