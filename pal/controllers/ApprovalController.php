...
class ApprovalController {
    ...
    public function index(): void {
        ...
        require PAL_ROOT . '/views/approvals/index.php';
    }
    ...
    public function startForm(): void {
        ...
        require PAL_ROOT . '/views/approvals/start.php';
    }
    ...
    public function view(int $id): void {
        ...
        if (!$req) { http_response_code(404); require PAL_ROOT . '/views/errors/404.php'; return; }
        ...
        require PAL_ROOT . '/views/approvals/view.php';
    }
    ...
    public function cancel(int $id): void {
        ...
        if ((int)$req['requested_by'] !== Auth::id() && Auth::role() !== 'admin') { http_response_code(403); require PAL_ROOT . '/views/errors/403.php'; return; }
