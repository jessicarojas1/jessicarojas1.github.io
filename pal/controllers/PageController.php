...
class PageController {
    ...
    public function createForm(int $spaceId = 0): void {
        ...
        $page = null;
        require PAL_ROOT . '/views/pages/form.php';
    }
    ...
    public function view(int $id): void {
        ...
        if (!$page) { http_response_code(404); require PAL_ROOT . '/views/errors/404.php'; return; }
        ...
        require PAL_ROOT . '/views/pages/view.php';
    }
    ...
    public function history(int $id): void {
        ...
        require PAL_ROOT . '/views/pages/history.php';
    }
