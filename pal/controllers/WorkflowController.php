...
class WorkflowController {
    ...
    public function index(): void {
        ...
        require PAL_ROOT . '/views/workflows/index.php';
    }
    ...
    public function view(int $id): void {
        ...
        if (!$wf) { http_response_code(404); require PAL_ROOT . '/views/errors/404.php'; return; }
        ...
        require PAL_ROOT . '/views/workflows/view.php';
    }

    public function createForm(): void {
        Auth::requirePermission('workflow.manage');
        $users = Database::fetchAll("SELECT id, name FROM users WHERE is_active=TRUE ORDER BY name");
        require PAL_ROOT . '/views/workflows/form.php';
    }
