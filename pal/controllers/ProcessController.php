...
class ProcessController {
    ...
    public function index(): void {
        ...
        require PAL_ROOT . '/views/processes/index.php';
    }
    ...
    public function view(int $id): void {
        ...
        if (!$process) { http_response_code(404); require PAL_ROOT . '/views/errors/404.php'; return; }
        ...
        require PAL_ROOT . '/views/processes/view.php';
    }
    ...
    public function createForm(): void {
        ...
        require PAL_ROOT . '/views/processes/form.php';
    }
