...
class SpaceController {
    ...
    public function index(): void {
        ...
        require PAL_ROOT . '/views/spaces/index.php';
    }
    ...
    public function view(int $id): void {
        ...
        if (!$space) { http_response_code(404); require PAL_ROOT . '/views/errors/404.php'; return; }
        ...
        require PAL_ROOT . '/views/spaces/view.php';
    }

    public function createForm(): void {
        Auth::requirePermission('space.create');
        $space = null;
        require PAL_ROOT . '/views/spaces/form.php';
    }
