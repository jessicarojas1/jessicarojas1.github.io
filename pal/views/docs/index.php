...
<div class="page-header">
  <div>
    ...
    <p class="page-subtitle">Everything you need to know about the PAL Platform.</p>
  </div>
</div>

<!-- About -->
<div class="card" style="margin-bottom:18px">
  <div class="card-header"><div class="card-header-left"><span class="card-title"><i class="bi bi-info-circle"></i> About PAL</span></div></div>
  <div class="card-body">
    <div class="prose">
      <p><strong>PAL</strong> is the <strong>Process, Approval &amp; Library</strong> platform — a single, governed home for
      your organization's controlled documents, knowledge pages, business processes and the approval workflows that keep
      them trustworthy. PAL combines a structured content library with a configurable workflow engine, granular
...
<div class="card" style="margin-bottom:18px">
  ...
  <div class="card-body">
    <div class="prose">
      <p>PAL uses granular, role-based access control. Each role grants a sensible set of module &times; action defaults;
...
<div class="card">
  ...
  <div class="card-body">
    <div class="prose">
      <p>PAL exposes a read-oriented REST API under <code>GET /api/v1/*</code> for integrating the library with other
