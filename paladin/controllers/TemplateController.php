...
class TemplateController {
    ...
    public function index(): void {
        ...
        require PALADIN_ROOT . '/views/templates/index.php';
    }
    ...
    public function view(int $id): void {
        ...
        if (!$template) { http_response_code(404); require PALADIN_ROOT . '/views/errors/404.php'; return; }
        require PALADIN_ROOT . '/views/templates/view.php';
    }

    public function createForm(): void {
        Auth::requirePermission('template.manage');
        $template = null;
        require PALADIN_ROOT . '/views/templates/form.php';
    }
