...
$routes = [
    'GET' => [
        ...
        '/oidc/login'                => ['OidcController', 'login'],
        '/oidc/callback'             => ['OidcController', 'callback'],
        ...
        '/admin/webhooks/dead-letters' => ['AdminController', 'webhookDeadLetters'],
...
$dynamicRoutes = [
    'GET' => [
        ...
        '#^/spaces/(\d+)/export-word$#'      => ['SpaceController', 'exportWord'],
        ...
        '#^/pages/(\d+)/docx$#'              => ['PageController', 'docx'],
        ...
        '#^/documents/(\d+)/docx$#'          => ['DocumentController', 'docx'],
    ...
    'POST' => [
        ...
        '#^/spaces/(\d+)/bulk$#'              => ['PageController', 'bulk'],
        '#^/spaces/(\d+)/members$#'              => ['SpaceController', 'addMember'],
        '#^/spaces/(\d+)/shortcuts$#'            => ['SpaceController', 'addShortcut'],
        '#^/spaces/(\d+)/shortcuts/(\d+)/delete$#' => ['SpaceController', 'removeShortcut'],
        '#^/spaces/(\d+)/members/(\d+)/update$#' => ['SpaceController', 'updateMember'],
        ...
        '#^/pages/(\d+)/move-space$#'       => ['PageController', 'moveToSpace'],
        '#^/pages/(\d+)/duplicate$#'        => ['PageController', 'duplicate'],
        ...
        '#^/documents/(\d+)/extend-review$#' => ['DocumentController', 'extendReview'],
        ...
        '#^/admin/webhook-deliveries/(\d+)/replay$#' => ['AdminController', 'replayWebhookDelivery'],
