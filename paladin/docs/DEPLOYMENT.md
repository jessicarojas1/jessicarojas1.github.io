# PALADIN — Deployment & Government Cloud Guidance

PALADIN is **cloud-agnostic** and **offline-friendly**: a single container image plus a
...
- **Docker Swarm:** `docker stack deploy -c docker-compose.yml paladin` (move secrets to
