...
<div class="page-header">
  ...
  <div class="page-actions"><a href="/pages/<?= (int)$page['id'] ?>" class="btn btn-ghost"><i class="bi bi-arrow-left"></i> Back to page</a></div>
</div>
    ...
    <?php foreach ($versions as $v): ?>
      <tr>
        ...
        <td style="text-align:right">
          ...
          <form method="POST" action="/pages/<?= (int)$page['id'] ?>/restore/<?= (int)$v['version'] ?>" style="margin:0" data-confirm="Restore this version as a new revision?"><?= Security::csrfField() ?><button class="btn btn-sm btn-ghost" type="submit"><i class="bi bi-arrow-counterclockwise"></i> Restore</button></form>
          <?php endif; ?>
        </td>
      </tr>
    <?php endforeach; ?>
